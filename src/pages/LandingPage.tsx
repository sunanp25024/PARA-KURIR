...
import { Truck, Package, Shield, Clock, BarChart3, MapPin, Camera, CheckCircle, Users, Monitor, Smartphone, Download, Star, Zap, Globe } from 'lucide-react';
...
const LandingPage = () => {
  ...
  const advantages = ["Peningkatan efisiensi operasional hingga 80%", "Transparansi penuh dalam proses pengiriman", "Dokumentasi digital yang akurat dan tersimpan aman", "Monitoring real-time untuk semua level manajemen", "Integrasi mudah dengan sistem existing", "Support 24/7 dan training komprehensif"];
  const userRoles = [{
    role: "MASTER ADMIN",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2 sm:gap-3">
              ...
              <Button onClick={() => navigate('/login')} className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 shadow-lg transform hover:scale-105 transition-all duration-200 text-xs sm:text-sm px-3 sm:px-4 py-2" size="sm">
      ...
      <section className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-gray-900 mb-6 sm:mb-8 leading-tight">
            Revolusi Sistem
            <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent block py-[16px] px-0 mx-0 my-0">
              Kurir Digital
            </span>
          </h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12 max-w-4xl mx-auto">
            {stats.map((stat, index) => <div key={index} className="bg-white/60 backdrop-blur-sm rounded-xl p-4 sm:p-6 shadow-lg border border-white/30">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
            <Button size="lg" className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 shadow-xl transform hover:scale-105 transition-all duration-200 w-full sm:w-auto" onClick={() => navigate('/login')}>
            ...
            <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-50 shadow-lg transform hover:scale-105 transition-all duration-200 w-full sm:w-auto" onClick={handleDownloadAPK}>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white/50 backdrop-blur-sm relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, index) => <Card key={index} className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-white/70 backdrop-blur-sm h-full">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-br from-indigo-50/80 to-blue-50/80 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 max-w-5xl mx-auto">
            {advantages.map((advantage, index) => <div key={index} className="flex items-center space-x-3 sm:space-x-4 bg-white/60 backdrop-blur-sm p-4 sm:p-6 rounded-xl shadow-lg border border-white/30 hover:shadow-xl transition-all duration-300">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {userRoles.map((user, index) => <Card key={index} className="border-2 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 bg-white/70 backdrop-blur-sm border-white/30 h-full">
          ...
          <div className="text-center">
            <Button size="lg" className="bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 shadow-xl transform hover:scale-105 transition-all duration-200 w-full sm:w-auto max-w-sm mx-auto" onClick={() => navigate('/login')}>
              <Monitor className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
              Login ke Dashboard
            </Button>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center max-w-md sm:max-w-none mx-auto">
            <PWAInstallButton />
            <Button size="lg" variant="outline" className="text-base sm:text-lg px-6 sm:px-10 py-3 sm:py-4 border-2 border-white/80 text-white hover:bg-white/20 backdrop-blur-sm shadow-xl transform hover:scale-105 transition-all duration-200 w-full sm:w-auto" onClick={handleDownloadAPK}>
            ...
            <div className="col-span-1 lg:col-span-2">
              <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-6">
                <div className="bg-white/90 backdrop-blur-sm p-2 sm:p-3 rounded-xl shadow-lg border border-gray-600/30">
                  <img src="/lovable-uploads/c005202f-c3fd-4bcd-be23-7edff7d62bb7.png" alt="PARA Logo" className="h-6 w-6 sm:h-8 sm:w-8 object-contain" />
                </div>
                <div>
